	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
				$(this).prop("src","${pageContext.request.contextPath}/img/image?time="+new Date());
			});
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/img/image" title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
